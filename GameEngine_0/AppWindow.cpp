...
void AppWindow::onCreate()
{
	...
	m_wood_tex = GraphicsEngine::get()->getTextureManager()->createTextureFromFile(L"Textures\\wall.jpg");
	m_mesh = GraphicsEngine::get()->getMeshManager()->createMeshFromFile(L"Meshes\\teapot.obj");
