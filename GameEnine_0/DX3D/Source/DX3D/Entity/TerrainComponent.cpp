...
void TerrainComponent::generateTerrainMesh ( )
{
	...
	m_vertexShader = renderSytem->createVertexShader ( L"Assests/Shaders/Terrain.hlsl" ,"vsmain" );
	m_pixelShader = renderSytem->createPixelShader( L"Assests/Shaders/Terrain.hlsl", "psmain" );
}
